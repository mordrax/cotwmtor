...
export const Buildings = {
  ...
  MineEntrance:       {                            sprite:{offset: {x: 64, y: 0}}},
  Fountain:           {                            sprite:{offset: {x: 96, y: 96}}},
  Sign:               {                            sprite:{offset: {x: 160, y: 0}}},
  Well:               {                            sprite:{offset: {x: 160, y: 32}}},
  VegePatch:          {                            sprite:{offset: {x: 128, y: 32}}},
  Wagon:              {                            sprite:{offset: {x: 192, y: 32}}},
  StairsDown:         {                            sprite:{offset: {x: 96, y: 128}}},
  StairsUp:           {                            sprite:{offset: {x: 64, y: 128}}},
  DoorClosed:         {                            sprite:{offset: {x: 64, y: 160}}},
  DoorOpen:           {                            sprite:{offset: {x: 96, y: 160}}}
